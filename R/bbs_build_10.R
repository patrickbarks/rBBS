...
#' interest.
#'
#' @param bbs_dir Directory from which to load BBS data.
#' 
...
#' @param zeros Build in counts of zero? Defaults to \code{FALSE}. (See
#'   Details)
...
#' @param bcr Vector of Bird Conservation Region id numbers to subset to.
#'   Defaults to all available. (See BBS file \emph{BCR.txt})
#' @param strata Vector of physiographic strata id numbers to subset to.
#'   Defaults to all available. (See BBS file \emph{BBSStrata.txt})
#' @param aou Vector of species id numbers to subset to. Defaults to all
